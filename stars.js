//숫자데이터 입력받으면 검정별을 숫자데이터만큼 찍기 + 공백은 빈 별찍기
...
document.write(makeReviewTable("각방", "http://naver.me/5LfKibcx", "<img src = 'img/20200609.jpg'>", "연어덮밥",  9000, 4, "소고기덮밥",  8000, 3, "2020-06-09"))
...
let imgArr = ["img/20200623buffet1.jpg", "img/20200623buffet2.jpg", "img/20200623buffet3.jpg"] //이미지여러개넣기
let imgIndex = 0;

function imgslide(){
    firstImg.setAttribute("src", imgArr[imgIndex]);
    imgIndex++;
